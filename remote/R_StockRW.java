       ...
       implements RemoteStockRW_I
{
  ...
  public synchronized boolean buyStock2( String pName, int amount )
         throws StockException
  {
    return aStockRW.buyStock2( pName, amount );
  }
  
  public synchronized boolean addProduct2( String pName, int amount )
	         throws StockException
	  {
	    return aStockRW.addProduct2( pName, amount );
	  }
  ...
  public synchronized void addStock2( String pName, int amount )
         throws StockException
  {
    aStockRW.addStock2( pName, amount );
  }
   ...
   * @throws middle.StockException if underlying error
   */
  public synchronized void modifyStock2( Product product )
              throws StockException
  {
    aStockRW.modifyStock2( product );
  }
}
